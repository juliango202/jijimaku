...
Usage
=============
Launch by executing bin/jijimaku.bat on Windows, or bin/jijimaku in other OS.
See config.yaml for options.

Bug / Problem
=============
If you encounter a problem please create an issue at https://github.com/juliango202/jijimaku/issues/new
